                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tabel">
                        ...
                        <tbody>
                            ...
                            $ambil = $koneksi->query("SELECT * FROM pengguna where level='Admin'");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($data['idpengguna'] != $idpengguna) { ?>
                                            <a href="index.php?halaman=adminhapus&id=<?php echo $data['idpengguna']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Delete</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>ID Enterprise</label>
                                                        <input type="text" name="identerprise" value="<?= $data['identerprise'] ?>" class="form-control" placeholder="ID Enterprise" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>ID Sponsor</label>
...
if (isset($_POST["tambah"])) {
    ...
    $koneksi->query("INSERT INTO pengguna (nama, email, password, idsponsor, level, identerprise, nowa)
								VALUES('$nama','$email','$password','$idsponsor','Admin','$identerprise','$nowa')") or die(mysqli_error($koneksi));
